    ...
    return (
        <div className="flex items-center justify-center min-h-[80vh] container">
            <div className="glass p-8 rounded-2xl w-full max-w-md shadow-2xl animate-in fade-in zoom-in duration-300">
                <h1 className="text-3xl font-bold mb-2 text-center bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Create Account</h1>
                <p className="text-center text-muted-foreground mb-8">Join the Smart Issue Board</p>
